...
if ($UseStagingGroup -eq $true){
    ...
    $allHasMobileUsers = Invoke-MSGraphOperation -Get -APIVersion $graphVersion -Headers $AuthHeader -Resource "groups/$stagingGroupId/transitiveMembers/microsoft.graph.user?count=true"#&filter=userType ne 'Guest' and mobilePhone ne null"
